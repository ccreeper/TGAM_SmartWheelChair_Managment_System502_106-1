...
class MailTemplate
{
    ...
    {
        $content='你好！'.$this->username.'点击以下链接激活您的账号：http://140.143.140.195/wheelchair/public/index.php/user/login/activate?token='.$this->usertoken.' 本链接当日有效!';
        return $content;
    }
    public function toForgot()
    {
        $content='你好！'.$this->username.'点击以下链接更换您的账号密码：http://140.143.140.195/wheelchair/public/index.php/user/login/passwdchange?token='.$this->usertoken.' 本链接当日有效!';
        return $content;
    }
